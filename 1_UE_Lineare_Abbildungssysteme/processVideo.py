...
frameCount = 0
delayInMS = 200 #500 # can be reduced for exercise
...
while True:
    ...
    #TODO - Calculate difference between cumulated frame and avgFrame and color it red
