...
#test_mean_shift_with_animation("color_monkey_xxs.jpg", 15.0, 0.001, 200, title="Mean Shift Color Space XXS - Color Monkey")
# test_mean_shift_with_animation("color_monkey_xs.jpg", 30.0, 1.0, 2000, title="Color Space XS - Color Monkey - BW 30")
# test_mean_shift_with_animation("color_monkey_xs.jpg", 20.0, 1.0, 2000, title="Color Space XS - Color Monkey - BW 20")
# test_mean_shift_with_animation("color_monkey_xs.jpg", 10.0, 1.0, 2000, title="Color Space XS - Color Monkey - BW 10")
# test_mean_shift_with_animation("color_monkey_xs.jpg",  5.0, 1.0, 2000, title="Color Space XS - Color Monkey - BW 5")


test_mean_shift_with_animation("bird_xs.png", 40.0, 1.0, 2000, title="Color Space XS - Bird - BW 40")
# test_mean_shift_with_animation("bird_xs.png", 10.0, 1.0, 2000, title="Color Space XS - Bird - BW 10")
# test_mean_shift_with_animation("bird_xs.png",  5.0, 1.0, 2000, title="Color Space XS - Bird - BW 5")
