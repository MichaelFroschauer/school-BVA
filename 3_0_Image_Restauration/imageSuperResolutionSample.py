...
#image = cv2.imread("C:\\Users\\p21702\\Desktop\\data_1_4\\lena_small.png")
#imageOrig = cv2.imread("C:\\Users\\p21702\\Desktop\\data_1_4\\lena.png")
image = cv2.imread("./images/lena_small.png")
imageOrig = cv2.imread("./images/lena_small.png")
...
#cv2.imwrite("C:\\Users\\p21702\\Desktop\\data_1_4\\lena_upsampled.png", result)
cv2.imwrite("lena_upsampled.png", result)
